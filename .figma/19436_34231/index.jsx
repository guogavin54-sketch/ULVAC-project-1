      ...
      <div className={styles.contents}>
        <div className={styles.paragraph}>
          <p className={styles.backIn1952UlvacWasSt}>
            Promotion of Creation and Co-Creation of Innovation with Vacuum
            Technology as the Core
          </p>
          <p className={styles.backIn1952UlvacWasSt2}>
            We have provided products and materials based on vacuum technology that
            is essential to all industries. With our integrated group development
            organization, we create high value-added products and technologies
            through innovative and advanced technical development to meet the
            requirements of overseas device makers for speed, and to satisfy the
            actual and potential needs of our customers.
          </p>
        </div>
        <div className={styles.container3}>
          <div className={styles.container}>
            <div className={styles.frame17}>
              <img src="../image/mpqoyiv2-pms968u.svg" className={styles.memory} />
            </div>
          ...
          <div className={styles.container2}>
            <div className={styles.icon}>
              <img src="../image/mpqoyiv2-w7fvbpv.svg" className={styles.memory} />
            </div>
            <div className={styles.text}>
          ...
          <div className={styles.container2}>
            <div className={styles.icon}>
              <img src="../image/mpqoyiv2-jbqxmwh.svg" className={styles.memory} />
            </div>
            <div className={styles.text}>
              <p className={styles.semiconductorFocus}>
              ...
              <p className={styles.strengtheningTechnol}>
                ...
                Exploring new vacuum applications through co-creation with
                customers.
              </p>
            </div>
          </div>
        ...
        <div className={styles.banner}>
          <div className={styles.container4}>
            ...
            <p className={styles.rDBases}>*As of end of June 2025</p>
          </div>
          <div className={styles.button}>
            <p className={styles.superMiniaturization}>Learn more about R&D</p>
            <img src="../image/mpqoyiv2-9xzs7fh.svg" className={styles.memory} />
          </div>
        </div>
      </div>
    </div>
